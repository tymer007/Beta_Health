          ...
          <div>
            <form action="" className="flex flex-col gap-2 md:gap-4">
              ...
              <div className="flex flex-col md:flex-row gap-2 md:gap-4 pt-2 md:pt-4">
                ...
                <button
                  className="text-customOrange rounded-md bg-orange-100 p-2 md:w-1/2"
                  onClick={() =>
                    props.handleSubmit({ title, body: description, body: html, id: category, body: props.article.id })
                  }
                >Submit</button>
              </div>
            </form>
